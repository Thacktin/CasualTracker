...
@dso_cache = dso_local local_unnamed_addr global [640 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 254808769, ; hash 0xf3012c1, from name: aot-CasualTracker.Model.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 899532133, ; hash 0x359dc565, from name: libaot-CasualTracker.Persistence.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1034618721, ; hash 0x3dab0761, from name: aot-CasualTracker
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1433927843, ; hash 0x557800a3, from name: aot-CasualTracker.Model
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CasualTracker.Model.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	...
	%struct.DSOCacheEntry {
		i64 1465894101, ; hash 0x575fc4d5, from name: CasualTracker.Model
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CasualTracker.Model.dll.so
		ptr null; void* handle (0x0)
	}, ; 205
	...
	%struct.DSOCacheEntry {
		i64 1555989363, ; hash 0x5cbe8373, from name: libaot-CasualTracker.Model.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CasualTracker.Model.dll.so
		ptr null; void* handle (0x0)
	}, ; 220
	...
	%struct.DSOCacheEntry {
		i64 1580612429, ; hash 0x5e363b4d, from name: aot-CasualTracker.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CasualTracker.dll.so
		ptr null; void* handle (0x0)
	}, ; 222
	...
	%struct.DSOCacheEntry {
		i64 1690936596, ; hash 0x64c9a514, from name: CasualTracker.Persistence
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-CasualTracker.Persistence.dll.so
		ptr null; void* handle (0x0)
	}, ; 235
	...
	%struct.DSOCacheEntry {
		i64 2267897913, ; hash 0x872d6039, from name: CasualTracker
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CasualTracker.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 2516495786, ; hash 0x95feadaa, from name: CasualTracker.Model.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CasualTracker.Model.dll.so
		ptr null; void* handle (0x0)
	}, ; 379
	...
	%struct.DSOCacheEntry {
		i64 2595435588, ; hash 0x9ab33444, from name: libaot-CasualTracker.Persistence
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-CasualTracker.Persistence.dll.so
		ptr null; void* handle (0x0)
	}, ; 393
	...
	%struct.DSOCacheEntry {
		i64 2775644822, ; hash 0xa570fa96, from name: CasualTracker.Persistence.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-CasualTracker.Persistence.dll.so
		ptr null; void* handle (0x0)
	}, ; 423
	%struct.DSOCacheEntry {
		i64 2782366348, ; hash 0xa5d78a8c, from name: aot-CasualTracker.Persistence
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-CasualTracker.Persistence.dll.so
		ptr null; void* handle (0x0)
	}, ; 424
	...
	%struct.DSOCacheEntry {
		i64 3094609221, ; hash 0xb873fd45, from name: libaot-CasualTracker.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CasualTracker.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
	...
	%struct.DSOCacheEntry {
		i64 3179963400, ; hash 0xbd8a6408, from name: aot-CasualTracker.Persistence.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-CasualTracker.Persistence.dll.so
		ptr null; void* handle (0x0)
	}, ; 489
	...
	%struct.DSOCacheEntry {
		i64 3287848342, ; hash 0xc3f89596, from name: CasualTracker.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CasualTracker.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
	...
	%struct.DSOCacheEntry {
		i64 3724042786, ; hash 0xddf86222, from name: libaot-CasualTracker
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-CasualTracker.dll.so
		ptr null; void* handle (0x0)
	}, ; 559
	...
	%struct.DSOCacheEntry {
		i64 3977113450, ; hash 0xed0def6a, from name: libaot-CasualTracker.Model
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CasualTracker.Model.dll.so
		ptr null; void* handle (0x0)
	}, ; 594
